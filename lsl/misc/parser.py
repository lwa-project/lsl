...
def positive_or_zero_int(string):
    ...
    try:
        ...
        msg = f"{string!r} is a non-integer value"
...
def positive_or_zero_float(string):
    ...
    try:
        ...
        msg = f"{string!r} is a non-float value"
        raise ArgumentTypeError(msg)
    if value < 0.0:
        msg = f"{string!r} < 0.0"
        raise ArgumentTypeError(msg)
    ...
    try:
        ...
        try:
            ...
            if units1 is not None and units2 is None:
                msg = f"{string!r} must have units specified for the second value"
                raise ArgumentTypeError(msg)
...
def frequency(string):
    ...
    try:
        len(value)
        msg = f"{string!r} does not appear to be a single frequency"
        raise ArgumentTypeError(msg)
    except TypeError:
        pass
    return value
...
def frequency_range(string):
    ...
    try:
        ...
        msg = f"{string!r} does not appear to be a frequency range"
        raise ArgumentTypeError(msg)
    return value
...
def wavelength(string):
    ...
    try:
        len(value)
        msg = f"{string!r} does not appear to be a single wavelength"
        raise ArgumentTypeError(msg)
    except TypeError:
        pass
    return value
...
def wavelength_range(string):
    ...
    try:
        ...
        msg = f"{string!r} does not appear to be a wavelength range"
        raise ArgumentTypeError(msg)
    return value
...
def date(string):
    ...
    try:
        ...
        try:
            dt = datetime.strptime(f"{cstring} 00:00:00", "%Y/%m/%d %H:%M:%S")
        except ValueError:
            msg = f"{string!r} cannot be interpretted as an MJD or date string"
            raise ArgumentTypeError(msg)
...
def time(string):
    ...
    try:
        ...
        try:
            dt = datetime.strptime(f"2000/1/1 {string}", "%Y/%m/%d %H:%M:%S.%f")
        except ValueError:
            try:
                dt = datetime.strptime(f"2000/1/1 {string}", "%Y/%m/%d %H:%M:%S")
            except ValueError:
                msg = f"{string!r} cannot be interpretted as a time string"
                raise ArgumentTypeError(msg)
    ...
    if string in ('all', '*'):
        ...
        for item in string.split(','):
            ...
            try:
                ...
                msg = f"{string!r} contains non-integer values"
                raise ArgumentTypeError(msg)
        ...
        if mtch is not None:
            ...
            if mtch is not None:
                ...
                try:
                    ...
                    msg = f"{string!r} contains non-integer hostname values"
                    raise ArgumentTypeError(msg)
                ...
                if mtch is not None:
                    ...
                    msg = f"{string!r} contains invalid hostname values"
                    raise ArgumentTypeError(msg)
        value.extend( items )
    return value
