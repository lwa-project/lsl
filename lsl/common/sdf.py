...
__version__ = '1.1'
__revision__ = '$Rev$'
__all__ = ['Observer', 'ProjectOffice', 'Project', 'Session', 'Observation', 'TBW', 'TBN', 'DRX', 'Solar', 'Jovian', 'Stepped', 'BeamStep', 'parse_sdf',  'getObservationStartStop', 'is_valid', '__version__', '__revision__', '__all__']
...
class _DRXBase(Observation):
    ...
    def set_beamdipole_mode(self, stand, beamGain=0.04, dipoleGain=1.0, pol='X', station=lwa1):
