"""
Python module to read in DRX8 data.  DRX8 data consist of a time series of complex
...
This module defines the following classes for storing the DRX8 data found in a
file:
...
def get_beam_count(filehandle):
    """
    Find out how many beams are present by examining the first 32 DRX8
...
def get_frames_per_obs(filehandle):
    ...
    32 DRX8 records.  Return the number of frames per observations as a four-
