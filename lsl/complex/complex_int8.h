...
static NPY_INLINE void lsl_pack_ci8(signed char real, signed char imag, complex_int8* packed) {
    packed->real_imag  = (real * 16) & 0xF0;
    packed->real_imag |= ((imag * 16) >> 4) & 0x0F;
}
