...
"""
Unit test for lwa_user.nec_util module.
"""

############################################################
# $Id: test_nec_util.py 89 2010-05-20 22:47:17Z dwood $
############################################################
...
class nec_util_tests(unittest.TestCase):
    """
    A unittest.TestCase collection of unit tests for the lwa_user.nec_util
    module.
    """
