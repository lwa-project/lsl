...
"""
Unit test for lwa_user.catalog module.
"""

############################################################
# $Id: test_catalog.py 93 2010-05-21 18:29:27Z dwood $
############################################################
...
class catalog_tests(unittest.TestCase):
    """
    A unittest.TestCase collection of unit tests for the lwa_user.catalog
    module.
    """
