        ...
        for filename,type in zip((idiFile, idiAltFile, uvFile), ('FITS-IDI', 'Alt. FITS-IDI', 'UVFITS')):
            with self.subTest(filetype=type):
                ...
                with self.subTest(mode='phase only'):
                    ...
                    junk = selfcal.phase_only(aa, ds, ds, 173, 'XX', max_iter=1, inv_epsilon=0.01, verbose=False)
                ...
                with self.subTest(mode='delay only'):
                    ...
                    junk = selfcal.delay_only(aa, ds, ds, 173, 'XX', max_iter=1, inv_epsilon=0.01, verbose=False)
                ...
                with self.subTest(mode='delay and phase'):
                    ...
                    junk = selfcal.delay_and_phase(aa, ds, ds, 173, 'XX', max_iter=1, inv_epsilon=0.01, verbose=False)
