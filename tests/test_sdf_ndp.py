"""
Unit test for the lsl.common.sdfNDP module.
"""
...
from lsl.common import sdfNDP, sdf as other_sdf
...
class sdf_ndp_tests(unittest.TestCase):
    ...
    def test_time(self):
        """Test the sdfNDP.parse_time() function."""
        ...
        self.assertEqual(sdfNDP.parse_time(s1), sdfNDP.parse_time(s2))
        self.assertEqual(sdfNDP.parse_time(s1), sdfNDP.parse_time(s3))
        self.assertEqual(sdfNDP.parse_time(s1), sdfNDP.parse_time(s4))
        self.assertEqual(sdfNDP.parse_time(s1), sdfNDP.parse_time(s5))
        self.assertEqual(sdfNDP.parse_time(s2), sdfNDP.parse_time(s3))
        self.assertEqual(sdfNDP.parse_time(s2), sdfNDP.parse_time(s4))
        self.assertEqual(sdfNDP.parse_time(s2), sdfNDP.parse_time(s5))
        self.assertEqual(sdfNDP.parse_time(s3), sdfNDP.parse_time(s4))
        self.assertEqual(sdfNDP.parse_time(s3), sdfNDP.parse_time(s5))
        self.assertEqual(sdfNDP.parse_time(s4), sdfNDP.parse_time(s5))
        ...
        s2 = "UTC 2013-01-08 19:38:29.512"
        self.assertEqual(sdfNDP.parse_time(s1, station=lwana), sdfNDP.parse_time(s2))
    ...
    def test_tbw_parse(self):
        ...
        self.assertRaises(RuntimeError, sdfNDP.parse_sdf, tbwFile)
    ...
    def test_tbn_parse(self):
        ...
        self.assertRaises(RuntimeError, sdfNDP.parse_sdf, tbnFile)
    ...
    def test_drx_parse(self):
        ...
        project = sdfNDP.parse_sdf(drxFile)
    ...
    def test_drx_update(self):
        ...
        dt0, dt1 = sdfNDP.get_observation_start_stop(project.sessions[0].observations[1])
    ...
    def test_sol_parse(self):
        ...
        project = sdfNDP.parse_sdf(solFile)
    ...
    def test_jov_parse(self):
        ...
        project = sdfNDP.parse_sdf(jovFile)
    ...
    def test_lun_parse(self):
        ...
        project = sdfNDP.parse_sdf(lunFile)
    ...
    def test_stp_parse(self):
        ...
        project = sdfNDP.parse_sdf(stpFile)
    ...
    def test_spc_parse(self):
        ...
        project = sdfNDP.parse_sdf(spcFile)
    ...
    def test_beamdipole_update(self):
        ...
        project = sdfNDP.parse_sdf(drxFile)
        project.sessions[0].observations[1].set_beamdipole_mode(37)
    ...
    def test_beamdipole_errors(self):
        ...
        project = sdfNDP.parse_sdf(drxFile)
        project.sessions[0].observations[0].set_beamdipole_mode(37)
        ...
        # Bad beam gain
        self.assertRaises(ValueError, project.sessions[0].observations[0].set_beamdipole_mode, 37, beam_gain=-0.1)
        self.assertRaises(ValueError, project.sessions[0].observations[0].set_beamdipole_mode, 37, beam_gain=1.1)
        
        # Bad dipole gain
        self.assertRaises(ValueError, project.sessions[0].observations[0].set_beamdipole_mode, 37, dipole_gain=-0.1)
        self.assertRaises(ValueError, project.sessions[0].observations[0].set_beamdipole_mode, 37, dipole_gain=1.1)
        
        # Bad polarization
        self.assertRaises(ValueError, project.sessions[0].observations[0].set_beamdipole_mode, 37, pol='L')
        self.assertRaises(ValueError, project.sessions[0].observations[0].set_beamdipole_mode, 37, pol='R')
    ...
    def test_tbf_parse(self):
        ...
        project = sdfNDP.parse_sdf(tbfFile)
    ...
    def test_auto_update(self):
        ...
        project = sdfNDP.parse_sdf(os.path.join(self.testPath, 'sdf.txt'))
        self.assertEqual(project.sessions[0].observations[1].freq1, 1643482384)
    ...
    def test_set_station(self):
        ...
        project = sdfNDP.parse_sdf(drxFile)
        project.sessions[0].station = lwana
        self.assertTrue(project.validate())
    ...
    def test_is_valid(self):
        ...
        self.assertTrue(sdfNDP.is_valid(drxFile))
        self.assertTrue(sdfNDP.is_valid(solFile))
        self.assertTrue(sdfNDP.is_valid(jovFile))
        self.assertTrue(sdfNDP.is_valid(stpFile))
        self.assertTrue(sdfNDP.is_valid(spcFile))
        self.assertTrue(sdfNDP.is_valid(tbfFile))
        
    def test_is_not_valid(self):
        """Test whether or not is_valid works on LWA1, LWA-SV, and IDF files."""
        
        self.assertFalse(sdfNDP.is_valid(tbwFile))
        self.assertFalse(sdfNDP.is_valid(tbnFile))
        self.assertFalse(sdfNDP.is_valid(idfFile))
...
class sdf_ndp_test_suite(unittest.TestSuite):
    ...
    def __init__(self):
        ...
        self.addTests(loader.loadTestsFromTestCase(sdf_ndp_tests)) 
